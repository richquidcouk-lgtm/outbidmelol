...
export const alt = "Claim a spot on Outbid Me — pay to rank #1";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 60, fontWeight: 900, color: "#f3f5fa" }}>
          Claim a spot
        </div>
        <div style={{ fontSize: 28, color: "#2fe17e", fontWeight: 700 }}>
          $5 minimum — pay more than the listing above you
        </div>
      </div>
    ),
    { ...size },
